...
# The longest a leaf chunk may be. It is the retrieval unit, so it is also the
# most text any single hit can carry back to a reader - anything downstream that
# shortens a hit below this drops part of a passage the search already matched.
MAX_CHUNK_CHARS = 1200
# How much of the previous leaf a split passage repeats, so a sentence cut in
# two is whole in at least one of them.
