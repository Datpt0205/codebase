...
/**
 * `ComponentProps<"button">` rather than `ButtonHTMLAttributes`, for one
 * reason: it carries `ref`. React 19 hands a function component its ref as an
 * ordinary prop, so this already worked at runtime - the type was the only
 * thing saying it did not, and a caller that wraps this in a tooltip or a
 * popover trigger needs the node.
 */
