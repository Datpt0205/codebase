...
const defaultComponents = memoizeMarkdownComponents({
  ...
  // Cấp cho khối code: Shiki tô màu, và trong lúc còn stream thì nó bỏ qua
  // bước tokenize, nên câu trả lời chạy chữ không tốn gì - lúc xong mới đổi
  // màu, không nhảy layout.
  SyntaxHighlighter,
  CodeHeader,
});
