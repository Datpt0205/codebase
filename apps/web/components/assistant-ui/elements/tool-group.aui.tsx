...
function ToolGroupTrigger({
  ...
  active?: boolean;
  /**
   * What the row says instead of "N tool calls".
   *
   * Local addition. A web lookup is a step of the turn like any other and
   * belongs in this shell, but "3 tool calls" is not what happened - what
   * happened is a search for a particular thing. Without this the row would
   * either lose the query or need a second shell that looks almost the same.
   */
