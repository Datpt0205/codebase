...
export type ThreadComponents = {
  ...
  /**
   * Rendered at the start of the composer action row, where the built-in
...
export const Thread: FC<ThreadProps> = ({
  ...
  const isEmpty = emptyLayout === "docked" ? false : isNewChat;
...
const ThreadRoot: FC<{ isEmpty: boolean; autoFocus: boolean }> = ({
  ...
  return (
    ...
    >
      ...
      {/* Local addition. Bôi đen một đoạn trong câu trả lời rồi hỏi tiếp về
          đúng đoạn đó - trước đây phải copy tay và dán lại vào ô nhập. */}
      <SelectionToolbar />
    </ThreadPrimitive.Root>
  );
};
...
const ComposerLeadingSlot: FC = () => {
  ...
  return ComposerLeading ? <ComposerLeading /> : <span />;
};

const ComposerAccessorySlot: FC = () => {
  const { ComposerAccessory } = useContext(ThreadComponentsContext);
  return ComposerAccessory ? <ComposerAccessory /> : null;
};
...
const AssistantActionBar: FC = () => {
  return (
    ...
    >
      ...
      {/* Local addition. A turn here can spend half a minute reading records,
          and "was that slow, or is it always this slow" is a question support
          gets asked. The badge only appears once the stream has finished. */}
      <MessageTiming />
